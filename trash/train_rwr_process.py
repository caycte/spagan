...
from rwr_process import RWR_process
...
parser.add_argument('--sparse', action='store_true', default=False, help='Use sparse matrix operations.')
parser.add_argument('--RWR', type=bool, default=True, help='Use sparse matrix operations.')
